...
INSERT INTO `Department` VALUES (38,'Psychology','unic.ac.cy','Philosophy','UNIC'),(3,'Electrical & Computer Engineering','ethz.ch','Engineering','ETH'),(7,'Informatics','csd.auth.gr','Sciences','AUTH'),(18,'Electrical & Computer Engineering','nanoeng.twente.nl','Engineering','UT'),(32,'Mathematics','maths.uow.edu.au','Sciences','UOW'),(34,'Psychology','psy.essex.ac.uk','Philosophy','ESSEX'),(67,'Mathematics','maths.ox.ac.uk','Sciences','OX'),(89,'Electrical & Computer Engineering','ee.duth.gr','Engineering','DUTH'),(94,'Law','law.eur.nl','Law','EUR'),(95,'Mechanical Engineering','meng.auth.gr','Engineering','AUTH'),(101,'Law','law.auth.gr','Law','AUTH'),(107,'Management','economics.marburg.de','Economics','MAR'),(121,'Dentistry','med.kuleuven.be','Health Sciences','KU'),(184,'Electrical & Computer Engineering','ee.auth.gr','Engineering','AUTH'),(230,'History & Archaeology','hist.auth.gr','Philosophy','AUTH');
